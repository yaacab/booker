...
| AUTO-014 | P2 | frontend | a11y + reduced motion audit cabinets | A | `apps/web/**` | **DONE** | e2e | `3c7c3fc` | AUTO-009 |
| AUTO-015 | P2 | ops | CI branch master→main fix | E | `.github/workflows/ci.yml` | **DONE** | CI | — | — |

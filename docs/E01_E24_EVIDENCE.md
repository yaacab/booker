...
**Candidate SHA:** `40e7072dec8b8c45415185184cd2443a1549a238` (`40e7072`)  
...
| E06 | Autosave / reload / offline | `e2e/studio-autosave.spec.ts`; event-studio-map E06 | **PARTIAL** | `40e7072` | Reload PASS; offline/retry thin |
| E07 | Заявка → оффер одна сущность | `e2e/deal-path.spec.ts` E07; flow; cross-role | **PASS** | `40e7072` | In CI critical list |
| E08 | Новая версия оффера | `test_quote_versioning.py`; deal-path E08 | **PASS** | `40e7072` | Old acks invalid until re-ack |
| E09 | Двойной hold | `test_hold_race.py`; deal-path E09 | **PASS** | `40e7072` | One 200 + one 409 |
...
| E24 | 390 + keyboard | `cabinet-a11y.spec.ts`; `docs/screenshots/g2-roles/` | **PASS** | `40e7072` | Full SR audit still manual |
...
| ---- | ---- |
| CI green on candidate SHA | Expanded e2e-critical; await green on `40e7072` |

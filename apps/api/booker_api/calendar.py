...
def overlapping_slots(
    ...
    *,
    ...
    incoming_start = starts_at - timedelta(minutes=buffer_before_min or 0)
    incoming_end = ends_at + timedelta(minutes=buffer_after_min or 0)
    ...
    for slot in q.all():
        before = getattr(slot, "buffer_before_min", 0) or 0
        after = getattr(slot, "buffer_after_min", 0) or 0
